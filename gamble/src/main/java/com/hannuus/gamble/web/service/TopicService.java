...
public interface TopicService {
	 ...
	 * @return
	 */
	List<Topic> findCategoryTopicsByPage(Long categoryId, int pageNumber,
			int pageSize);
	 ...
	 * @return Topic list
	 */
	List<Topic> findTopicsBySpeciaId(Long specialId);
	 ...
	 * @return
	 */
	List<Topic> findSpeciaTopicsByPage(Long specialId, int pageNumber,
			int pageSize);
	 ...
	 * @return
	 */
	List<Topic> searchByPage(SearchTopicParamDTO dto, int pageNumber,
			int pageSize);
