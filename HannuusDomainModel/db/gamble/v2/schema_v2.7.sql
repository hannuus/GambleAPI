...
CREATE TABLE `certificate_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `type_name` varchar(45) DEFAULT NULL COMMENT '类型文本值',
  `type_value` varchar(45) DEFAULT NULL COMMENT '类型逻辑值',
  PRIMARY KEY (`id`)
...
CREATE TABLE `right` (
  ...
  `right_type` varchar(45) DEFAULT NULL COMMENT 'Folder-文件夹 Document-普通菜单',
  PRIMARY KEY (`id`)
...
CREATE TABLE `topic` (
  ...
  `topic_type` int(11) NOT NULL COMMENT '0-normal 1-vote 2-virtual',
  `user_id` bigint(20) DEFAULT NULL COMMENT 'FK 用户ID',
...
CREATE TABLE `user` (
  ...
  `certificate_num` varchar(100) DEFAULT NULL COMMENT '证件号码',
  `certificate_type_id` bigint(20) DEFAULT NULL COMMENT 'FK 证件类型ID',
...
-- Dump completed on 2015-09-21 21:35:14
